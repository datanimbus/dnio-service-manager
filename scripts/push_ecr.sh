...
docker tag data.stack.base:$TAG $ECR_URL/data.stack.base:$TAG
docker push $ECR_URL/data.stack.base:$TAG


echo "****************************************************"
echo "data.stack:sm :: Image pushed to ECR AS $ECR_URL/data.stack.base:$TAG"
echo "****************************************************"